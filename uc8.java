...
public class uc8 {
    ...
    /**
     * TicTacToe UC8 controls the continuous game loop and alternates turns
     * until the game ends.
     */
    public class TicTacToe {
        ...
        /**
         * Entry point of the program. Demonstrates the structure of a
        ...
        public static void main(String[] args) {
            ...
            while (!gameOver) {
                ...
                if (isHumanTurn) {
                    System.out.println("Human's turn (" + humanSymbol + "):");
                    humanMove();
                } else {
